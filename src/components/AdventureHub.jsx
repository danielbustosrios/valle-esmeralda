...
const ITEMS=[
  ...
  {id:'five',name:'Reto por un 5,0',description:'Desbloquea un reto especial para obtener un 5,0 en Cálculo.',cost:40,currency:'◆',icon:'🏅',academic:true},
