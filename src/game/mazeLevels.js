export const MAZE_LEVELS=[
  ...
  {id:34,name:'La guardia de piedra',width:31,height:23,seed:3413,keyCount:3,timeLimit:0,parMoves:600,enemyCount:2,enemySpeed:760},
  {id:35,name:'Los anillos vigilados',width:21,height:19,seed:3511,keyCount:2,timeLimit:0,parMoves:380,enemyCount:1,enemySpeed:1050,rotating:true,round:true,rotationInterval:18},
  {id:36,name:'El núcleo giratorio',width:23,height:21,seed:3613,keyCount:2,timeLimit:0,parMoves:440,enemyCount:1,enemySpeed:950,rotating:true,round:true,rotationInterval:16},
